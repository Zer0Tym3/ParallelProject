...
public class TCPServer {
    public static void main(String[] args) throws IOException {
        ...
        String routerName = ServerNames.getRouterName(); // ServerRouter host name
        int SockNum = 5555; // port number

        // Who am I
        InetAddress addr = InetAddress.getLocalHost();
        String localIPAddress = addr.getHostAddress(); // Server machine's IP
        String localHostName = addr.getCanonicalHostName(); // Server machine's IP
        ...
        Reader reader = new FileReader("src/data/Video.mp4");
        FileWriter fw = new FileWriter(ServerNames.getVidFile2());
        ...
        String address = ServerNames.getServerAddress(); // destination IP (Server)
        long t0, t1, t;
        ...
        //Load File
        File file = new File(ServerNames.getVidFile2());
        if (file.exists()){
